...
public interface ReservasDao extends JpaRepository <Reservas, Long> {
    ...
    public List<Reservas> metodoJPQL(@Param("idVuelo") int idVuelo, @Param("idCliente") int idCliente);
    ...
    public List<Reservas> metodoNativo(@Param("idVuelo") int idVuelo, @Param("idCliente") int idCliente);
